...
class colornamefinderWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/colornamefinder');
        }
        ...
        this.validationRules = {"hex":{"type":"string","required":true,"format":"hexColor"},"closest":{"type":"integer","required":false,"min":1,"max":20,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/colornamefinder`);
        }
    }
...
module.exports = colornamefinderWrapper;
