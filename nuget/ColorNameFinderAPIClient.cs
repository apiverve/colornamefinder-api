...
namespace APIVerve.API.ColorNameFinder
{
    ...
    /// <summary>
    /// Client for the ColorNameFinder API
    /// </summary>
    public class ColorNameFinderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/colornamefinder";
        ...
        {
            { "hex", new ValidationRule { Type = "string", Required = true, Format = "hexColor" } },
            { "closest", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 20 } }
        };
        ...
        public ColorNameFinderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ColorNameFinderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ColorNameFinderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ColorNameFinderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ColorNameFinderQueryOptions options)
        {
        ...
        public ResponseObj Execute(ColorNameFinderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ColorNameFinderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ColorNameFinderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ColorNameFinderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ColorNameFinderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ColorNameFinderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ColorNameFinderQueryOptions options)
        {
