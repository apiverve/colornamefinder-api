...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/colornamefinder',
        'Source': 'https://github.com/apiverve/colornamefinder-api',
        'Bug Tracker': 'https://github.com/apiverve/colornamefinder-api/issues'
    },
    classifiers=[
