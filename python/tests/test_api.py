...
class TestColornamefinderAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ColornamefinderAPIClient(self.api_key)

    @patch('apiverve_colornamefinder.apiClient.requests.get')
