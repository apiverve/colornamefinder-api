...
```gradle
dependencies {
    implementation 'com.github.apiverve:colornamefinder-api:1.1.13'
}
```
...
```java
import com.apiverve.colornamefinder.ColorNameFinderAPIClient;
import com.apiverve.colornamefinder.APIResponse;
import com.apiverve.colornamefinder.APIException;

// Initialize the client
ColorNameFinderAPIClient client = new ColorNameFinderAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("hex", "FF5733");
    parameters.put("closest", 1);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/colornamefinder](https://docs.apiverve.com/ref/colornamefinder)
...
- **Documentation:** [https://docs.apiverve.com/ref/colornamefinder](https://docs.apiverve.com/ref/colornamefinder)
- **Issues:** [GitHub Issues](https://github.com/apiverve/colornamefinder-api/issues)
