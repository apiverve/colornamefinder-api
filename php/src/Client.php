...
namespace APIVerve\Colornamefinder;
...
/**
 * Client for the Color Name Finder API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/colornamefinder?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/colornamefinder';
    ...
    private const VALIDATION_RULES = [
        ...
        'closest' => ['type' => 'integer', 'required' => false, 'min' => 1, 'max' => 20]
    ];
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ColornamefinderClient] {$message}\n";
        }
    }
}
